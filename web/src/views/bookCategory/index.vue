...
<template>
  <!-- 现代化对话框 -->
  <el-dialog v-model="dialogFormVisible" title="添加图书分类" class="modern-dialog">
    <el-form :model="form" :rules="rules" ref="isValidForm" class="modern-form">
      ...
      <el-form-item label="关键词" prop="keywords">
        <el-input v-model="form.keywords" placeholder="请输入关键词" class="modern-input" />
      </el-form-item>
  ...
  <div class="modern-category-management">
    <!-- 页面标题 -->
    <div class="page-header">
      <div class="header-content">
        ...
        <p class="page-subtitle">管理图书分类信息，包括新增、编辑、删除等操作</p>
      </div>
    </div>
    ...
    <div class="table-container modern-card">
      ...
      >
        ...
        <el-table-column prop="keywords" label="关键词" min-width="200">
          <template #default="scope">
            <div class="keywords-container">
              <el-tag
                v-for="keyword in scope.row.keywords.split(',')"
                :key="keyword"
                size="small"
                type="info"
                effect="dark"
        ...
        <el-table-column prop="notes" label="备注" min-width="300" show-overflow-tooltip />
